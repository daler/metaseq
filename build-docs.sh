...
# the newly-generated docs at daler.github.io/metaseq.
...
(python setup.py develop && cd doc && make notebooks html)
HERE=$(pwd)
...
git clone git@github.com:daler/metaseq.git $TMPREPO
cd $TMPREPO
